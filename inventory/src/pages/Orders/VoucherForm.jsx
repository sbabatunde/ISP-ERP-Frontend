...
function VoucherForm() {
  ...
  return (
    <div className="p-4">
      <div
        ref={componentRef}
        className="p-6 bg-white border border-gray-300 rounded-lg print:p-0 print:border-0"
      >
        {/* Header */}
        <div className="flex justify-between items-start mb-4">
          ...
          <div className="text-right">
            ...
            <p className="font-semibold mt-4">
              ...
              <input
                type="text"
                className=" border-b uppercase font-bold border-gray-300 outline-none w-32"
              />
            </p>
          </div>
        </div>
        ...
        <div className="mb-4">
          <p className="font-semibold">
            ...
            <input
              type="text"
              className="font-normal border-b border-gray-300 outline-none w-32"
            />
          </p>
        </div>
        ...
        <div className="mb-4 overflow-x-auto">
          <table className="w-full border border-gray-300">
            <thead className="bg-gray-100">
              <tr>
                {["DETAILED DESCRIPTION", "UNIT PRICE", "AMOUNT"].map(
                  (header, idx) => (
                    <th
                      key={idx}
                      className="border border-gray-300 p-2 text-left font-semibold text-sm"
                    >
                      {header}
                    </th>
                  ),
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="border border-gray-300 p-2 text-sm text-right font-bold">
                  {currencyFormat(order?.total_cost ?? 0)}
                </td>
              </tr>
            </tbody>
          </table>
        ...
        <div className="mb-4 grid grid-cols-1 md:grid-cols-2 gap-4">
          {[
            ...
            <div key={idx} className="mb-2">
              ...
              <input
                type="text"
                className="w-full border-b border-gray-300 p-1 outline-none"
        ...
        <div className="flex flex-col md:flex-row justify-between gap-4 mb-4">
          <div className="flex-1">
            ...
            <p className="border border-gray-300 p-2 text-sm min-h-12">
              {order?.total_cost
                ? toWords.convert(Number(order?.total_cost), {
                    currency: "NGN",
                  })
                : ""}
            </p>
          ...
          <div className="flex-1">
            ...
            <p className="border border-gray-300 p-2 text-sm">
              {currencyFormat(order?.total_cost ?? 0)}
            </p>
          </div>
        </div>
        ...
        {/* Note */}
        <p className="text-xs mt-2 italic font-bold text-gray-500 text-center">
          Kindly Attach Receipt
        </p>
        <p className="text-xs mt-2 italic text-gray-500 text-center">
          Note: Only within the state transport expenses are allowed for
          transport expenses. Only the Admin Department is exempted.
        </p>
      </div>
      <button
