                            ...
                            {[
                                ...
                                <div key={index} className="space-y-1">
                                    ...
                                    <input
                                        ...
                                        id={detail.key}
                                        className="w-full px-3 text-gray-600 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-colors"
                                    />
                                </div>
                            ))}
                        </div>
