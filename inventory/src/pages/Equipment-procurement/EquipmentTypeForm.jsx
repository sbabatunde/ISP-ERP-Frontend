            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  required
                  className="w-full px-3 py-2 text-sm rounded border text-white border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-slate-900 dark:text-white"
                ></textarea>
              </div>
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  required
                  className="w-full px-3 text-white py-2 text-sm rounded border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-slate-900 dark:text-white"
                >
