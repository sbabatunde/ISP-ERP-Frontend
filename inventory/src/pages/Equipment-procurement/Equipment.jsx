        ...
        <form onSubmit={handleSubmit} className="divide-y divide-slate-200 dark:divide-slate-700">
          ...
          <div className="p-5 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm mb-2 text-slate-600 dark:text-slate-400">Equipment Name*</label>
                <input
                  type="text"
                  name="name"
                  value={formData.name}
              ...
              <div>
                <label className="block text-sm mb-2 text-slate-600 dark:text-slate-400">Model Number*</label>
                <input
                  type="text"
                  name="model"
          ...
          <div className="p-5 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm mb-2 text-slate-600 dark:text-slate-400">Equipment Type*</label>
                <select
              ...
              <div>
                <label className="block text-sm mb-2 text-slate-600 dark:text-slate-400">Unit Cost (₦)*</label>
                <input
                  type="number"
                  name="unit_cost"
          ...
          <div className="p-5 space-y-4">
            ...
            <div>
              <label className="block text-sm mb-2 text-slate-600 dark:text-slate-400">Upload Images (max 5)</label>
              <input
                type="file"
                name="images"
                multiple
